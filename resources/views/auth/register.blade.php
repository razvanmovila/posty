        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="name" placeholder="Choose a password"
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="name" placeholder="Repeat your password"
